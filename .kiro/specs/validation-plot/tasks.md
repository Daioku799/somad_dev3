...
- [x] 1. Foundation: 共通パレットとスライサーの基盤整備
...
- [x] 2. Core: スナップショット検証プロットの実装
- [x] 2.1 (P) スナップショットデータの読み込みロジック
...
- [x] 3. Integration & Validation: モジュール統合と最終確認
- [x] 3.1 モジュールエントリの更新と公開
